...
class Yolov5TRT(object):
    ...
    """
    def __init__(self, engine_file, wts_name):
        ...
        assert engine, "Get engine failed"
        ...
        for binding in engine:
            ...
            print('bingding:', binding, binding_shape)
    ...
    def infer(self, raw_image_gen):
        ...
        for i, image_raw in enumerate(raw_image_gen):
        ...
        [cuda.memcpy_dtoh_async(host_out, cuda_out, stream) for host_out, cuda_out in zip(host_outputs, cuda_outputs)]
...
class WarmUpThread(threading.Thread):
    ...
    def run(self):
        batch_image_raw, use_time = self.wrapper.infer(self.wrapper.get_raw_image_zeros())
